...
12. [BOJ_4991 로봇 청소기](#12-boj_4991-로봇-청소기-백준-링크-소스-코드)
...
## 12. BOJ_4991 로봇 청소기 [(백준 링크)](https://www.acmicpc.net/problem/4991) [(소스 코드)](https://github.com/rldnjs7723/CodingTest/blob/main/BOJ/4000/Main_4991.java)

### 문제 요약

더러운 곳의 좌표가 주어질 때 모든 더러운 곳을 청소하는 이동 횟수의 최솟값을 계산하는 문제.

### 풀이 아이디어

더러운 곳의 개수가 10개밖에 안 되기 때문에 충분히 비트마스크로 나타낼 수 있다고 판단하였고, 단순히 BFS와 결합하여 다이나믹 프로그래밍을 수행하여 문제를 해결하였다.
